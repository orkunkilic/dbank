...
contract('dBank', ([deployer, user]) => {
  ...
  describe('testing getters..', () => {
    it('should return etherBalanceOf', async () => {
      ...
      await wait(2);
      expect(
        (await dbank.getEthereumBalanceOf({ from: user })).toString()
  ...
  describe('testing borrow...', () => {
    describe('success', () => {
      ...
      it('collateralEther should increase', async () => {
        expect(Number(await dbank.etherCollateral(user))).to.eq(10 ** 16); //0.01 ETH
      });
  ...
  describe('testing payOff...', () => {
    describe('success', () => {
      ...
      it('borrower data should be reseted', async () => {
        expect(Number(await dbank.etherCollateral(user))).to.eq(0);
